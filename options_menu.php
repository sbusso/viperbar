...
<div id="Viper_main_container">
	...
	<form method="post" action="" enctype="multipart/form-data" id="Viper_main_form">
		...
		<div id="Viper_panel_main">fix_synchronized_backgrounds
			<div id="Viper_panel_general">
				...
				<div class="Viper_form_element">
					<div class="Viper_label">Fix Synchronized Backgrounds?</div>
					<div class="Viper_input">
						<input type="radio" name="fix_synchronized_backgrounds" value="true" <?php echo ($options['fix_synchronized_backgrounds'] == "true") ? 'checked="checked"' : ''; ?>>Yes
						<input type="radio" name="fix_synchronized_backgrounds" value="false" <?php echo ($options['fix_synchronized_backgrounds'] == "false") ? 'checked="checked"' : ''; ?>>No
					</div>
				</div>
				<br style="clear: both;">
			</div>
